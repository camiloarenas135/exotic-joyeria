                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6 mt-10">
                    ...
                    <p className="font-sans font-light text-white/70 leading-relaxed text-lg text-center max-w-lg mx-auto">
                      <strong className="text-gold">No realizamos devolución de dinero.</strong>
                    </p>
                    <p className="font-sans font-light text-white/70 leading-relaxed text-lg text-center max-w-lg mx-auto">
                      Por temas de garantía se devuelve el mismo accesorio u otros accesorios por el mismo valor.
                    </p>
                  </div>
