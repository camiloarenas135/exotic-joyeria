              ...
              <div className="p-8 md:p-12 relative">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-6 mt-10">
                    ...
                    <p className="font-sans font-light text-white/70 leading-relaxed text-lg text-center max-w-lg mx-auto">
                      Los envíos nacionales se harán por <strong>Inter Rapidísimo</strong> los días Martes y Jueves de cada semana. 
                    </p>
                    <p className="font-sans font-light text-white/70 leading-relaxed text-lg text-center max-w-lg mx-auto">
                      Se demorarán de <strong className="text-gold">2 a 4 días hábiles</strong>.
                    </p>
                  </div>
